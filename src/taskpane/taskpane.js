  ...
  try {
    ...
    await Excel.run(async context => {
      ...
      for (var i = 0; i < projectResponses.values.length; i++) {
        ...
        var level3CalculationDetails = CalculateLevelScore(projectResponses.values[i], responseScores, level3MaturityIndexes, 5);
        var level4CalculationDetails = CalculateLevelScore(projectResponses.values[i], responseScores, level4MaturityIndexes, 5);
